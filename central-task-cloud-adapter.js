 ...
 document.addEventListener('DOMContentLoaded',async()=>{
  ...
  window.createTask=async function(e){
   ...
   try{
    ...
    const owner=assignmentType==='additional_role'?'delegated_roles':document.getElementById('sourceOwner').value;
    ...
    if(assignmentType==='additional_role'){
