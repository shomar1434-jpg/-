(function(){
 ...
 const mapTask=t=>({task_id:t.id,school_id:t.school_id,title:t.title,description:t.description||'',assignment_type:t.assignment_type,source_owner:t.source_owner||'',record_key:t.record_key||'',module_key:t.module_key||'',record_type:t.record_type||'',record_id:t.record_id||'',metadata:t.metadata||{},owner_role:t.owner_role||'',owner_label:t.owner_label||'',owner_id:t.created_by,responsible_user_id:(t.metadata&&t.metadata.responsible_user_id)||t.created_by,responsible_email:(t.metadata&&t.metadata.responsible_email)||(t.metadata&&t.metadata.reviewer_email)||'',responsible_role:(t.metadata&&t.metadata.responsible_role)||(t.metadata&&t.metadata.reviewer_role)||t.owner_role||'',responsible_name:(t.metadata&&t.metadata.responsible_name)||(t.metadata&&t.metadata.reviewer_name)||t.owner_label||'',reviewer_id:(t.metadata&&t.metadata.reviewer_id)||t.created_by,reviewer_email:(t.metadata&&t.metadata.reviewer_email)||'',reviewer_role:(t.metadata&&t.metadata.reviewer_role)||t.owner_role||'',reviewer_name:(t.metadata&&t.metadata.reviewer_name)||t.owner_label||'',assignee_id:t.assigned_to||'',assignee_email:t.assignee_email||'',assignee_name:t.assignee_name||'',assignee_role:t.assignee_role||'',priority:t.priority,start_date:t.start_date||'',due_date:t.due_date||'',status:t.status,progress_percent:t.progress_percent||0,created_at:t.created_at,updated_at:t.updated_at,pending_updates:(t.central_task_updates||[]).map(u=>{const ev=(t.central_task_evidence||[]).filter(e=>String(e.update_id||'')===String(u.id));return {id:u.id,title:u.title||'',desc:u.notes||'',link:u.link_url||'',at:u.created_at,status:u.status,progress_percent:u.progress_percent,cloud_file_id:ev[0]&&(ev[0].platform_file_id||ev[0].file_id)||'',evidence:ev}}),evidence:t.central_task_evidence||[],history:[],_cloud:true,_raw:t});
