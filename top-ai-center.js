(function(){
  ...
  function collectContext(){
    ...
    return '[سياق المنصة]\nاسم المنصة: منصة القيادة المدرسية الذكية\nالقسم الحالي: '+m.section+'\nالدور: '+m.role+'\nالمدرسة: '+(m.schoolName||'غير محددة')+'\nالمستخدم: '+(m.userName||'غير محدد')+'\n\n[الحقول الحالية]\n'+fields+'\n\n[عناصر الصفحة الظاهرة]\n'+visibleText+'\n\n[محتوى الملف المرفوع إن وجد]\n'+(state.lastFileText||state.lastFileName||'لا يوجد ملف مرفوع');
  }
  function instruction(){
    var m=getMeta();
    return 'أنت AI School Copilot، المساعد المدرسي الذكي داخل منصة القيادة المدرسية الذكية. أجب بالعربية الفصحى المناسبة للمدارس في السعودية. التزم بسياق القسم الحالي فقط: '+m.section+'. اجعل المخرجات قابلة للتنفيذ داخل النموذج المفتوح، ولا تقترح نموذجًا جديدًا إذا كان المطلوب استكمال نموذج قائم. استخدم صيغًا تصلح للجنسين.';
  }
