...
/* extracted inline script 2 */
        ...
        const renderGrid = (role) => {
            ...
            if (!grid) return;
            grid.innerHTML = '';
            const apps = role === 'leadership' ? ['leadership', 'agency', 'performance', 'student_advisor'] : [role];
            apps.forEach(appId => {
                const titles = { 'leadership': '🏛️ قسم مدير النظام', 'agency': '📑 قسم الوكيل/ة', 'performance': '👨‍🏫 قسم المعلم/ة', 'student_advisor': '🧭 قسم الموجه الطلابي' };
        ...
        const launchApp = (appId) => {
            const files = { 'leadership': 'manager.html', 'agency': 'agent.html', 'performance': 'teacher.html', 'student_advisor': 'student_advisor.html' };
        ...
        const roleLabel = (role) => {
            const labels = { leadership: 'قسم مدير النظام', agency: 'قسم الوكيل/ة', performance: 'قسم المعلم/ة', student_advisor: 'قسم الموجه الطلابي' };
