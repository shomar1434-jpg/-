          ...
          if(uniqueLinks.length){
            ...
            for(const l of uniqueLinks){
              ...
              for(const ev of taskEvents||[]){
                const matches=String(ev.module_key||'')===String(l.module_key||'')&&String(ev.record_type||'')===String(l.record_type||'')&&(!l.record_id||!ev.record_id||String(ev.record_id)===String(l.record_id));
